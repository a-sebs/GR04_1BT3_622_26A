                    ...
                    <c:if test="${not empty matchSeleccionado}">
                        ...
                        <div class="actions footer-actions">
                            <a class="btn btn-primary"
                                href="${pageContext.request.contextPath}/sesion/agenda/${matchSeleccionado.id}">Contactar
                                Usuario</a>
                        </div>
                    </c:if>

                    <div class="actions footer-actions">
                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/match/lista">Volver a mis
                            matches</a>
